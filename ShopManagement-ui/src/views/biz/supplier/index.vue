<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="供应商负责人" align="center" prop="supplierManager" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="供应商负责人" prop="supplierManager">
          <el-input v-model="form.supplierManager" placeholder="请输入供应商负责人" />
        </el-form-item>
        <el-form-item label="供应商电话" prop="supplierPhone">
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from "@/api/biz/supplier";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('biz/supplier/export', {
        ...this.queryParams
