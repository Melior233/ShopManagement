...
{
    private final IBizWarehouseService bizWarehouseService;

    public BizWarehouseController(IBizWarehouseService bizWarehouseService) {
        this.bizWarehouseService = bizWarehouseService;
    }
